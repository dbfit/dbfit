...
public interface DBEnvironment {
	...
	/**
	 * A flag to signal whether the database supports output parameters from
	 * insert commands to be fetched thru result set.
	 * 
	 * If this method returns true, then result set will be used to
	 * retrieve possible outputs after an insert. if not, then we retrieve the 
   * possible outputs from the registeredOutputParameters of the CallableStatement.
	 */
	boolean supportsOuputOnInsertViaResultSet();
