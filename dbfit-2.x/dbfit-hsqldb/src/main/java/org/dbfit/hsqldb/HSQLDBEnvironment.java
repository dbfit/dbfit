...
public class HSQLDBEnvironment extends AbstractDbEnvironment {
     ...
     * prepareStatement(java.lang.String sql, int autoGeneratedKeys) method is not supported by HSQLDB
     *
    ...
    public Map<String, DbParameterAccessor> getAllProcedureParameters(String s) throws SQLException {
        throw new UnsupportedOperationException();
    }
    ...
    public static class HsqldbTypeMapper implements TypeMapper {
        private static final List<String> stringTypes = Arrays.asList("VARCHAR", "VARCHAR_IGNORECASE",
                "CHAR", "CHARACTER", "LONGVARCHAR");
        ...
        private static final List<String> doubleTypes = Arrays.asList("DOUBLE", "DOUBLE PRECISION",
                "FLOAT", "REAL");
        private static final List<String> shortTypes = Arrays.asList("SMALLINT");
        private static final List<String> decimalTypes = Arrays.asList("DECIMAL", "NUMERIC");
        private static final List<String> dateTypes = Arrays.asList("DATE");
        private static final List<String> timestampTypes = Arrays.asList("TIMESTAMP", "DATETIME");
        private static final List<String> timeTypes = Arrays.asList("TIME");
        private static final List<String> booleanTypes = Arrays.asList("BOOLEAN", "BIT");
        private static final List<String> byteTypes = Arrays.asList("BINARY", "VARBINARY", "LONGVARBINARY");
        ...
        public Class<?> getJavaClassForDBType(final String dbDataType) {
            ...
            if (byteTypes.contains(dataType))
                return Byte.class;
            throw new UnsupportedOperationException("Type '" + dbDataType + "' is not supported for HSQLDB");
        }
