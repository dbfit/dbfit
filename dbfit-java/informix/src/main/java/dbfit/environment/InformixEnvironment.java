...
public class InformixEnvironment extends AbstractDbEnvironment {
    ...
    private static final List<String> timestampTypes = Arrays.asList(
            ...
            "DATETIME MINUTE TO FRACTION(1)", "DATETIME MINUTE TO FRACTION(2)", "DATETIME MINUTE TO FRACTION(3)", "DATETIME MINUTE TO FRACTION(4)", "DATETIME MINUTE TO FRACTION(5)",
    ...
    private static final List<String> timeTypes = Arrays.asList(
