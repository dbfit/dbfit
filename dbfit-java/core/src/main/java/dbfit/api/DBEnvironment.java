...
public interface DBEnvironment {
     ...
     * name.
     */
    Map<String, ParameterOrColumn> getAllProcedureParameters(String procName)
            throws SQLException;
     ...
     */
    Map<String, ParameterOrColumn> getAllColumns(String tableOrViewName)
            throws SQLException;
     ...
     * rows in a table.
     */
    PreparedStatement buildInsertPreparedStatement(String tableName, ParameterOrColumn[] accessors)
            throws SQLException;
     ...
     *
     * You normally want to use AutoGeneratedColumn here
     */
    ParameterOrColumn createAutogeneratedPrimaryKeyColumn(ParameterOrColumn template);
    ...
    DbStoredProcedureCall newStoredProcedureCall(String name, ParameterOrColumn[] accessors);
}
