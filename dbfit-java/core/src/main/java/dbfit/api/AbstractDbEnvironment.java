...
//            System.out.println("paramNames length "+paramNames.length);
            if (Options.isBindSymbols()){
            	PreparedStatement cs=getConnection().prepareStatement(parseCommandText(commandText));
        ...
        protected abstract String getConnectionString(String dataSource, String database);
		 ...
		 public Connection getConnection() throws SQLException {
		  ...
		  /**
		   * by default, uses a string generated by buildInsertCommand and
		   * creates a statement that returns generated keys via JDBC
		   */
		  ...
		  /**
		   * This method should generate a valid insert statement which is used
		   * by buildInsertPreparedStatement to create the actual statement. It is isolated
