...
public class SnowflakeDbEnvironmentUnitTests {
    ...
    public void buildInsertCommand_AllInputParameters() throws Exception {
        SnowflakeEnvironment env = new SnowflakeEnvironment("Snowflake");

        String expectedResult = "insert into DummyTable(Column1,Column_Two,ColumnThree) values (?,?,?)";
        ...
        parameters[1] = new DbParameterAccessor("Column_Two", Direction.INPUT, 0, null, 1, dbfitToJdbcTransformerFactory);
