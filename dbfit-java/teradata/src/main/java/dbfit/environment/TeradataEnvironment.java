...
public class TeradataEnvironment extends AbstractDbEnvironment {
	...
	public TeradataEnvironment() {
        ...
        try {
            TypeNormaliserFactory.setNormaliser(Class.forName("com.teradata.jdbc.ResultStruct"), new TeradataPeriodNormaliser());
        } catch (ClassNotFoundException e) {
            throw new Error("Cannot initialise Teradata result struct. Is the Teradata jar in the classpath?", e);
        }
    }
