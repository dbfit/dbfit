...
public class OracleEnvironment extends AbstractDbEnvironment {
    ...
    private ParameterOrColumn addSingleParam(Map<String, ParameterOrColumn> allParams,
            DbParameterOrColumnInfo info) {
        ParameterOrColumn dbp = makeSingleParam(info);
    ...
    private ParameterOrColumn makeSingleParam(DbParameterOrColumnInfo info) {
        return makeSingleParam(info.name, info.dataType, info.direction, info.position);
    }

    private ParameterOrColumn makeSingleParam(
        ...
        ParameterOrColumn dbp = new OracleParameterOrColumn(paramName,
    ...
    @Override
    public ParameterOrColumn createAutogeneratedPrimaryKeyColumn(
            ParameterOrColumn template) {
        ParameterOrColumn accessor2 = template.clone();
    ...
    @Override
    public DbStoredProcedureCall newStoredProcedureCall(String name, ParameterOrColumn[] accessors) {
