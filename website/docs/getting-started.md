...
<div class="alert alert-info alert-block">
 ...
 1. <a class="btn btn-success" href="https://github.com/dbfit/dbfit/releases/download/v{{ site.dbfit_version }}/dbfit-complete-{{ site.dbfit_version }}.zip" onclick="recordOutboundLink(this, 'Software', '{{ site.dbfit_version }}', 'Getting started');return false;">Download DbFit</a>
